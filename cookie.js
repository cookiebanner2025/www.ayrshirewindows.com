...
const config = {
    // Domain restriction
    allowedDomains: ['www.ayrshirewindows.com'],
    
    // Privacy policy URL (configurable)
    privacyPolicyUrl: 'https://www.ayrshirewindows.com/privacy-policy/', // Add your full privacy policy URL here
...
geoConfig: {
    ...
    border: '1px solid #72b239 !important',
    hover: {
